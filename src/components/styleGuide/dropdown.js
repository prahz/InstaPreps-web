...
export function Dropdown() {
  ...
  return (
    <div ref={container} className='relative inline-block m-2 mx-auto text-left'>
      <div>
        <button
          type='button'
      ...
      <Transition
        ...
        className='absolute left-0 z-10 mt-2 origin-top-left border rounded-md shadow-xs w-52'
        show={isOpen}
      >
